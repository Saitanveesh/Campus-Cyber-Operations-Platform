...
from campus_ops.console_cleanup_ui import CONSOLE_CLEANUP_EXTENSION
...
from campus_ops.enterprise_ui import ENTERPRISE_UI_EXTENSION
...
from campus_ops.link_state_ui import LINK_STATE_EXTENSION
from campus_ops.operator_notice_ui import OPERATOR_NOTICE_EXTENSION
from campus_ops.pathspace_ui import PATHSPACE_EXTENSION
from campus_ops.red_panel_ui import RED_PANEL_EXTENSION
from campus_ops.tool_hub_ui import TOOL_HUB_EXTENSION
...
def _clean_console_copy(html: str) -> str:
    replacements = {
        "Live Operations Console": "Operational Console",
        "LIVE OPERATIONS CONSOLE": "OPERATIONAL CONSOLE",
